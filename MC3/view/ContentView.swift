        ...
        NavigationStack {
            ScrollView{
                ...
                VStack {
                    ...
                    HStack {
                        VStack(alignment: .leading) {
                            Text("\(statisticsViewModel.totalDuration)")
                                .font(.title)
                                .fontWeight(.bold)
                            Text("Time")
                                .font(.caption)
                        ...
                        VStack(alignment: .leading) {
                            Text("\(statisticsViewModel.averageAccuracy)%")
                                .font(.title)
                                .fontWeight(.bold)
                            Text("Accuracy")
                                .font(.caption)
            ...
            .onAppear {
                ...
                statisticsViewModel.fetchStatistics {
                    statisticsViewModel.saveToLeaderboard()
                }
            ...
            if isLoading {
                ...
                .frame(maxWidth: .infinity, maxHeight: .infinity) // Biar full screen
            }
